...
import integration.model.Article
import integration.model.Author
import integration.model.Man
import integration.model.Woman
...
class ManyToOneTest : FunSpec(){
    ...
    init {
        ...
        val ormSchema = YamlSchemaCreator(ResourceLoader.loadText("article-author-schema.yml"), SnakeCaseNamingStrategy()).create()
...
//                    ?: error("not found")
//            val book1 = integration.Book::class.findById(1L)
//                    ?: error("not found")
...
//            saved shouldBe integration.Book(1, "BOOK_1",
//                listOf(
//                        Color(2L, "COLOR_2"),
//                        Color(1L, "COLOR_1")
//                )
...
//
//            integration.Book::class.findById(1L) shouldBe integration.Book(1, "BOOK_1", listOf())
//        }
